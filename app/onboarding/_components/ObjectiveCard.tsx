    ...
    <div
      ...
      className={`relative flex items-start gap-4 p-4 sm:p-5 rounded-2xl border cursor-pointer transition-all duration-200 ${
        isChecked
          ...
          : "bg-white border-slate-200 hover:border-emerald-500/40 hover:shadow-2xs"
      }`}
    >
      {/* Icon optional */}
      {Icon && (
      ...
      <div className="flex-1 min-w-0 pr-2">
        <div className="font-bold text-[14.5px] sm:text-[15.5px] mb-1 leading-tight text-slate-900">
          {title}
        </div>
