...
export function AgencyCalculatorPreview({
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50/70 via-slate-50 to-emerald-50/50 border border-blue-200/70 rounded-2xl p-4 sm:p-5 shadow-xs space-y-3">
      {/* Header avec badge Loi 2022-30 */}
      <div className="flex items-center justify-between gap-2 pb-2.5 border-b border-blue-200/50">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg bg-blue-600/10 text-blue-700 flex items-center justify-center shrink-0">
        ...
        <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10.5px] font-bold bg-blue-600/10 text-blue-700 border border-blue-600/20 shrink-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
        {/* Vos Honoraires (10%) */}
        <div className="bg-card p-3 rounded-xl border border-blue-200/60 shadow-2xs space-y-1">
        ...
        <div className="bg-card p-3 rounded-xl border border-emerald-200/60 shadow-2xs space-y-1">
          <div className="flex items-center justify-between">
          ...
          <div className="text-[17px] font-extrabold text-emerald-700 font-mono">
