  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-[#E8E5E0] rounded-[12px] p-6 shadow-xs">
        <h2 className="text-[16px] font-bold text-[#1C1C1C] mb-4">Informations Personnelles</h2>
      ...
      <div className="bg-white border border-[#E8E5E0] rounded-[12px] p-6 shadow-xs">
        <h2 className="text-[16px] font-bold text-[#1C1C1C] mb-4">Pièce d'identité (CIP / Passeport)</h2>
        <label className="w-full h-32 flex flex-col items-center justify-center gap-2 border-2 border-dashed border-[#E8E5E0] rounded-[8px] bg-[#FAF9F6] text-[#64635F] cursor-pointer hover:bg-gray-50 transition-colors">
          <ArrowUpTrayIcon className="w-6 h-6 text-[#1C1C1C]" />
          <span className="text-[12px] font-bold text-[#1C1C1C]">Téléverser un document</span>
      ...
      <div className="bg-white border border-[#E8E5E0] rounded-[12px] p-6 shadow-xs">
        <h2 className="text-[16px] font-bold text-[#1C1C1C] mb-4">Contact d'urgence</h2>
        <div className="space-y-4">
          <div>
      ...
      <div className="bg-white border border-[#E8E5E0] rounded-[12px] p-6 shadow-xs">
        <h2 className="text-[16px] font-bold text-[#1C1C1C] mb-4">Sécurité</h2>
        <div className="space-y-4">
          <div>
