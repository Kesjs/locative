  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-[#E8E5E0] rounded-[12px] overflow-hidden shadow-xs">
        ...
        <div className="p-6">
          <h2 className="text-[18px] font-bold text-[#0F172A] mb-1">Villa Les Cocotiers, Apt 2B</h2>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-[#FAF9F6] p-3 rounded-[8px] border border-[#E8E5E0]">
              ...
              <span className="text-[14px] font-bold text-[#0F172A]">150 000 FCFA</span>
            </div>
            <div className="bg-[#FAF9F6] p-3 rounded-[8px] border border-[#E8E5E0]">
              <span className="block text-[11px] font-bold text-[#9C9A95] uppercase">Échéance</span>
              <span className="text-[14px] font-bold text-[#0F172A]">Le 05 du mois</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button className="w-full flex items-center justify-between p-3 border border-[#E8E5E0] rounded-[8px] hover:bg-gray-50 transition-colors">
              <span className="text-[13px] font-medium text-[#0F172A]">Contrat de bail</span>
              <DocumentArrowDownIcon className="w-5 h-5 text-[#64635F]" />
            </button>
            <button className="w-full flex items-center justify-between p-3 border border-[#E8E5E0] rounded-[8px] hover:bg-gray-50 transition-colors">
              <span className="text-[13px] font-medium text-[#0F172A]">État des lieux d'entrée</span>
              <DocumentArrowDownIcon className="w-5 h-5 text-[#64635F]" />
            </button>
          </div>
        </div>
      ...
      <div className="bg-white border border-[#E8E5E0] rounded-[12px] p-6 shadow-xs">
        <h3 className="text-[14px] font-bold text-[#0F172A] mb-4">Contacts d'urgence</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-[#FAF9F6] rounded-[8px] border border-[#E8E5E0]">
            <div>
              <div className="text-[13px] font-bold text-[#0F172A]">Patrimoine Lokka</div>
              <div className="text-[11px] text-[#64635F]">Propriétaire Bailleur</div>
            </div>
            <a href="tel:+22997000000" className="w-10 h-10 rounded-full bg-[#0F172A] text-white flex items-center justify-center">
