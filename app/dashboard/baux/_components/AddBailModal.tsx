    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-[12px] p-6 max-w-md w-full shadow-2xl">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-[18px] font-bold text-[#0F172A]">Nouveau bail</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button type="submit" disabled={isPending || !formData.locataire} className="px-4 py-2 bg-[#0F172A] text-white text-[13px] font-bold rounded-[6px] disabled:opacity-50">
