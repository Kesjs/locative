  ...
  return (
    <div className="space-y-6 max-w-4xl pb-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-white border border-[#E8E5E0] text-[#0F172A] rounded-[6px] text-[13px] font-bold shadow-xs hover:bg-gray-50 transition-colors">
      ...
      <div className="bg-white border border-[#E8E5E0] rounded-[12px] p-6 shadow-xs relative overflow-hidden">
        ...
        <h2 className="text-[16px] font-bold text-[#0F172A] mb-5 flex items-center gap-2">
          <GlobeAltIcon className="w-5 h-5 text-[#D97706]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-2">
          <div>
            ...
            <div className="flex items-center border border-[#E8E5E0] rounded-[6px] overflow-hidden bg-white focus-within:ring-2 focus-within:ring-[#D97706]">
          ...
          <div className="flex items-end pb-1">
            <div className="flex items-center gap-1.5 text-[12px] font-bold text-[#D97706] bg-[#E6F5EF] border border-[#D97706]/20 px-3 py-2 rounded-full">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="border-2 border-dashed border-[#E8E5E0] bg-[#FAF9F6] rounded-[8px] p-8 text-center text-[12px] text-[#64635F] cursor-pointer hover:bg-white transition-colors">
              <div className="font-semibold text-[#0F172A] mb-1">Cliquez ou glissez-déposez votre logo ici</div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <button className="w-8 h-8 rounded-full bg-[#0F172A] border-2 border-transparent ring-2 ring-offset-2 ring-[#0F172A]"></button>
              <button className="w-8 h-8 rounded-full bg-[#D97706] border-2 border-transparent"></button>
      ...
      <div className="bg-white border border-[#E8E5E0] rounded-[12px] p-6 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button className="px-4 py-2 bg-white border border-[#E8E5E0] text-[#0F172A] hover:bg-gray-50 rounded-[6px] text-[13px] font-bold transition-colors">
          Gérer les articles
        </button>
      </div>
      ...
      <div className="flex justify-end pt-4 border-t border-[#E8E5E0]">
        <button 
          onClick={handleSave}
          disabled={isSaving}
          className="flex items-center gap-2 px-6 py-2 bg-[#0F172A] text-white rounded-[6px] text-[13px] font-bold shadow-md hover:bg-black transition-colors disabled:opacity-50"
        >
