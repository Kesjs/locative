      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div data-landing-reveal className="grid gap-10 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
          <div className="max-w-[350px]">
            <p className="landing-label">Notes de terrain</p>
            <h2 className="mt-4 text-[clamp(2rem,4vw,3.25rem)] font-semibold leading-[1] tracking-[-0.06em] text-text-primary">
              Des traces qui parlent<span className="mt-1 block font-serif font-normal italic text-text-secondary">à chaque métier.</span>
            </h2>
            <motion.div 
              ...
              className="mt-12 lg:mt-20 overflow-hidden rounded-[8px] border border-border-default shadow-sm"
            >
              <Image 
                src="/test.jpg" 
                alt="Illustration témoignage" 
                width={350} 
                height={250} 
