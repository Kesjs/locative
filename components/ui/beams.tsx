...
export default function Beams({
  ...
  useEffect(() => {
    ...
    vec3 getNormal(vec3 pos) {
      ...
      material: { fog: true },
      uniforms: {
        diffuse: new THREE.Color(...hexToNormalizedRGB("#020202")),
        time: { value: 0 },
        roughness: 0.4,
        metalness: 0.6,
        uSpeed: { value: speed },
    ...
    directionalLight = new THREE.DirectionalLight(new THREE.Color(lightColor), 1.2);
  ...
  return (
    <div
      ref={containerRef}
      className={`beams-container w-full h-full relative ${className}`}
