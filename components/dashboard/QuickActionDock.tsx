  ...
  return (
    <div className="w-full bg-white/80 backdrop-blur-md border border-[#E8E5E0] rounded-[12px] p-2.5 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-wrap items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-2 px-2">
        <div className="h-7 w-7 rounded-[6px] bg-[#1C1C1C] flex items-center justify-center text-white shadow-xs">
          <SparklesIcon className="h-4 w-4" />
        </div>
        <div>
          <span className="text-[12px] font-bold text-[#1C1C1C] block leading-tight">
            Actions Rapides
          </span>
      ...
      <div className="flex items-center flex-wrap gap-2">
        <motion.button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#1C1C1C] hover:bg-[#F5F5DC] hover:text-[#1C1C1C] hover:border-[#E8E5E0] border border-transparent text-white text-[12px] font-semibold rounded-[6px] transition-colors shadow-xs cursor-pointer"
        >
        ...
        <motion.a
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#FAF9F6] hover:bg-[#F3F2EE] border border-[#E8E5E0] text-[#1C1C1C] text-[12px] font-semibold rounded-[6px] transition-colors shadow-2xs cursor-pointer"
        >
